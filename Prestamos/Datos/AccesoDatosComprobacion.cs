...
{
    public class AccesoDatosComprobacion : IAccesoDatos
    {
        // Constructor
        public AccesoDatosComprobacion()
        {
            this.LimpiarEstado();
            Conexion = new NpgsqlConnection("Server=localhost;Port=5432;Database=postgres;Userid=postgres;Password=123;");
